...
# Change this to your bucket name, or set env GCS_BUCKET
BUCKET_NAME = os.environ.get("GCS_BUCKET", "dezoomcamp_hw3_2025")

# Use service account JSON if set; otherwise use default credentials (gcloud auth application-default login)
CREDENTIALS_FILE = os.environ.get("GOOGLE_APPLICATION_CREDENTIALS") or "gcs.json"
